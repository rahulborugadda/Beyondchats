...
export const collabText =
  "With smart automation and top-notch security, A truly customizable Chatbot with premium features.";

export const collabText2 =
  "Integrate your Business with AI and monitor your growth from multiple platforms. All possible at your command.";
...
export const pricing = [
  ...
  },
  {
    ...
    features: [
      ...
      "Emailers: Daily Stats + Monthly analysis",
      "AI Analysis & Qualified ⁠Business leads",
    ],
  },
  {
    id: "3",
    title: "Enterprise",
    description:
      "Reach out to us to discuss your needs and generate leads with our Chatbot. We'll tailor pricing to fit.",
    price: null,
    features: ["Contact to Know all the features"],
  },
];
